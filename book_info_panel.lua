...
--- Create the book info panel for the given available width.
-- Returns a tappable InputContainer, or nil if no document is open.
local function createBookInfoPanel(avail_w)
    local ReaderUI = require("apps/reader/readerui")
    local ui = ReaderUI.instance
    if not (ui and ui.document and ui.doc_props) then return nil end

    -- How much width is available for the text column after cover + margins
